...
function s:loc_vars(infoq, card)
  ...
  local last_card_text = last_card
      and localize { type = 'name_text', key = last_card.key, set = last_card.set }
      or localize('k_none')
        ...
        nodes = {
          {
            ...
            nodes = {
              { n = G.UIT.T, config = { text = ' ' .. last_card_text .. ' ', colour = G.C.UI.TEXT_LIGHT, scale = 0.3, shadow = true } },
            }
          }
        }
      }
